    ...
    <header class="border-b border-slate-800 bg-slate-900/80 backdrop-blur-md px-4 md:px-8 py-3 flex flex-col md:flex-row md:justify-between items-center shrink-0 relative z-50 gap-3 md:gap-4">
      <div class="flex items-center justify-between w-full md:w-auto gap-4 xl:gap-8 shrink-0">
        ...
        <button
          ...
          class="md:hidden px-3 py-2 bg-slate-800 text-slate-300 hover:text-white hover:bg-slate-700 rounded-full text-sm font-semibold transition-colors cursor-pointer flex items-center justify-center shrink-0"
        >
